...
4) AO correction can be turned on by selecting 'glao' or have no AO correction (i.e. natural seeing) by selecting 'noao'.
...
9) Combined instrument+filter throughput (between 0 to 1). Default value is 0.45 (current target for ULTIMATE).

10) The water vapor and airmass to select the background model. Default values are 1.6 mm and 1.0 respectively.

11) The temperature of the instrument. Default value is 273K.
